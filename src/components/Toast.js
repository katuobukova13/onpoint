...
const ADVANTAGES = [
  { "id": "01",
    "text": "Самое важное и ключевое преимущество  нашего препарата" },
    { "id": "02",
    "text": "Второе по важности преимущество" },
    { "id": "03",
    "text": "Ещё одно важное преимущество препарата"},
    { "id": "04",
    "text": "Ещё одно не менее важное преимущество препарата" },
    { "id": "05",
    "text": "Ещё одно важное преимущество препарата" },
    { "id": "06",
    "text": "Ещё одно важное преимущество препарата" }
...
const Toast = ({ toastState, setToastState }) => {
  ...
  return (
    <div className="toast">
      ...
      <Pagination advantagesPerPage={advantagesPerPage}
